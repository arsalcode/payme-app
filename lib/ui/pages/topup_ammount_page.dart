...
class TopupAmmountPage extends StatefulWidget {
  final String? bankName;

  const TopupAmmountPage({
    super.key,
    this.bankName = 'BCA',
  });

  @override
  State<TopupAmmountPage> createState() => _TopupAmmountPageState();
}

class _TopupAmmountPageState extends State<TopupAmmountPage> {
      ...
      body: BlocConsumer<TransactionBloc, TransactionState>(
        listener: (context, state) {
          ...
          if (state is TransactionSuccess) {
            // Segarkan data saldo user di AuthBloc
                  ...
                  if (pinVerified == true) {
                    if (context.mounted) {
                      context.read<TransactionBloc>().add(
                            TransactionTopUpEvent(
                              amount: amount,
                              bankName: widget.bankName ?? 'BCA',
                            ),
                          );
                    }
                  }
